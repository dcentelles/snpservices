...
$MRTGConfigSource='http://127.0.0.1/snpservices/graphs/cnml2mrtgcsv.php?server='.$SNPGraphServerId;
...
$CNMLSource='http://127.0.0.1/snpservices/common/qnodes.php?nodes=%s';

$CNMLData='../data/guifi.cnml';

// rrdtool parameters
$rrdtool_path='/usr/bin/rrdtool';
$rrddb_path='/var/www/html/snpservices/rrdb/';
$rrdimg_path='/var/www/html/snpservices/rrimg/';
